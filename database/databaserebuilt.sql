...
-- Complete SQL code to recreate the entire database
-- Student: [Jabulani Kalomo]
-- Date: [13 September 2025]

-- Step 1: Create PostgreSQL Type
...
-- Step 5: Create Relationship between Classification and Inventory
...
-- Step 6: Insert Classification Data
...
-- Step 8: Apply Assignment 2 Updates (Queries 4 & 6 copied from Task 1)
